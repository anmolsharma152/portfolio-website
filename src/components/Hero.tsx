...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-screen flex items-center justify-center relative z-10 bg-background">
      <motion.div 
      ...
      >
        ...
        >
          ...
          >
            Transforming data into actionable insights through advanced machine learning and artificial intelligence solutions.
          </motion.p>
        </motion.div>
